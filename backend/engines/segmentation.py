...
_B2B_DEFAULTS = [
    CustomerSegment(segment_name="Power Users", share=0.15,
    ...
    CustomerSegment(segment_name="Pragmatic Professionals", share=0.40,
    ...
    CustomerSegment(segment_name="Value Seekers", share=0.30,
    ...
    CustomerSegment(segment_name="Late Majority", share=0.15,
...
_CONSUMER_DEFAULTS = [
    CustomerSegment(segment_name="Early Adopters", share=0.12,
    ...
    CustomerSegment(segment_name="Engaged Mainstream", share=0.45,
    ...
    CustomerSegment(segment_name="Bargain Hunters", share=0.28,
    ...
    CustomerSegment(segment_name="Reluctant Adopters", share=0.15,
...
def generate_segments(product: ProductInput) -> tuple[list[CustomerSegment], bool]:
    ...
    if not USE_SARVAM:
        ...
        return (_B2B_DEFAULTS if is_b2b else _CONSUMER_DEFAULTS), False
    ...
    try:
        ...
        raw = [CustomerSegment(**s) for s in data["segments"]]
        ...
        is_b2b = (product.price >= 30 or any(
            kw in product.target_market.lower()
            for kw in ("team", "business", "company", "enterprise", "smb", "saas")
        ))
        return (_B2B_DEFAULTS if is_b2b else _CONSUMER_DEFAULTS), False
